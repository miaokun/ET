...
namespace ETHotfix {
  ...
  public partial class C2M_Chat : pb::IMessage {
    private static readonly pb::MessageParser<C2M_Chat> _parser = new pb::MessageParser<C2M_Chat>(() => (C2M_Chat)MessagePool.Instance.Fetch(typeof(C2M_Chat)));
    public static pb::MessageParser<C2M_Chat> Parser { get { return _parser; } }
  ...
  public partial class M2C_Chat : pb::IMessage {
    private static readonly pb::MessageParser<M2C_Chat> _parser = new pb::MessageParser<M2C_Chat>(() => (M2C_Chat)MessagePool.Instance.Fetch(typeof(M2C_Chat)));
    public static pb::MessageParser<M2C_Chat> Parser { get { return _parser; } }
